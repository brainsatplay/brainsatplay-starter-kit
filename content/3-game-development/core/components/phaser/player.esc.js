...
export function ongame(game){
    ...
    if (game){
        ...
        this.ref.body.setSize(this.ref.width + this.size.offset?.width ?? 0, this.ref.height + this.size.offset?.height ?? 0); // adjustment

        this.ref.setDisplaySize((this.size.width ?? 1)*this.ref.width, (this.size.height ?? 1) * this.ref.height); // adjustment
